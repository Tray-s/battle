...
player_items = [{"item": potion,  "quantity": 15}, {"item": hipotion, "quantity": 5},
                {"item": superpotion,  "quantity": 15}, {"item": elixer,  "quantity": 15},
                {"item": hielixer,  "quantity": 2}, {"item": grenade,  "quantity": 15}]

# Instantiate People
player1 = Person("Valos:", 3260, 65, 60, 34, player_spells, player_items)
player2 = Person("John :", 4160, 65, 60, 34, player_spells, player_items)
player3 = Person("Nick :", 3089, 65, 60, 34, player_spells, player_items)
